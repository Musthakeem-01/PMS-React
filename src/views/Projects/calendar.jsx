...
import { compareAsc, format,subDays,subWeeks,subMonths,subYears,addDays,
    ...
    <div className='flex justify-between pb-4'>
                    ...
                    <div className="flex justify-center items-center gap-1 ">
                        ...
                        <div className='text-white gap-2 rounded hover:bg-ShareHoveBG'>
                            <Button color="inherit" style={{textTransform:'capitalize'}}>{format(currentDate, formate)} </Button>
                        </div>
                        ...
                        <div className='flex gap-2 items-center text-white cursor-pointer'>
                            <button className='flex items-center gap-2 text-sm font-medium text-white px-3 h-8 bg-ShareHoveBG rounded '> Today</button>
                        </div>
                        ...
                        <div className='flex gap-2 items-center text-white cursor-pointer'>
                            <button className='flex items-center gap-2 text-sm font-medium text-white px-3 h-8 bg-transparent rounded hover:bg-ShareHoveBG'><IoIosCalendar className='w-4 h-4' />Unscheduled</button>
                        </div>

                        <div className='flex gap-2 items-center text-white cursor-pointer'>
                            <button className='flex items-center gap-2 text-sm font-medium text-white px-3 h-8 bg-transparent rounded hover:bg-ShareHoveBG'><IoFilter className='w-4 h-4' />Filter</button>
                        </div>
             ...
             <MonthCalendar ref={monthRef} 
              loading={e => props.loading(e)} 
              alertmsg={(e) => props.alertmsg({open: e.open,color:e.color,message:[e.message]})}
              />
