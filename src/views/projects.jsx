...
import { MdOutlineSpaceDashboard, MdOutlineBarChart, MdOutlineRunningWithErrors } from "react-icons/md";
...
const components = {
  ...
  Calendar,
  Timeline,
  Approvals: () => <div className="w-full h-96 text-white text-2xl font-bold flex justify-center items-center">Approvals</div>,
  Forms: () => <div className="w-full h-96 text-white text-2xl font-bold flex justify-center items-center">Forms</div>,
  Pages: () => <div className="w-full h-96 text-white text-2xl font-bold flex justify-center items-center">Pages</div>,
  Attachments: () => <div className="w-full h-96 text-white text-2xl font-bold flex justify-center items-center">Attachments</div>,
  Issues: () => (<div className="w-full h-96 text-white text-2xl font-bold flex justify-center items-center">Issues</div>),
  Reports: () => <div className="w-full h-96 text-white text-2xl font-bold flex justify-center items-center">Reports</div>,
  Shortcuts: () => <div className="w-full h-96 text-white text-2xl font-bold flex justify-center items-center">Shortcuts</div>,
};
    ...
    <div className="w-full h-screen bg-gradient-to-br from-NanoBGcolor1 via-NanoBGcolor2 to-NanoBGcolor3 flex flex-col">
      ...
      <div className="fixed top-12 left-0 right-0 z-10 border-ProjectHeaderBarBorderColor border-b">
        <div className="w-full pt-7 pr-7 pl-7 pb-2 flex justify-between items-center">
          <h1 className="text-2xl text-white font-medium cursor-pointer">Project - 1</h1>
        </div>
        <div className="w-full px-7 flex justify-start items-center overflow-x-auto">
          {ProjectLinks.map(({ key, label, icon: Icon }) => (
            ...
            ${activeLink === key ? "border-activeLinkBorderColor2 border-b-2" : "border-transparent border-b-2"} 
            cursor-pointer`}
            >
